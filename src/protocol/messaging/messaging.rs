...
impl<'a> Signature<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args SignatureArgs<'args>) -> flatbuffers::WIPOffset<Signature<'bldr>> {
  ...
  pub fn type_(&self) -> SignatureType {
    self._tab.get::<SignatureType>(Signature::VT_TYPE_, Some(SignatureType::PAYLOAD)).unwrap()
  }
  #[inline]
  pub fn signer(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_SIGNER, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn signature(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_SIGNATURE, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for Signature<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"signer", Self::VT_SIGNER, false)?
...
impl<'a: 'b, 'b> SignatureBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: SignatureType) {
    self.fbb_.push_slot::<SignatureType>(Signature::VT_TYPE_, type_, SignatureType::PAYLOAD);
  }
  #[inline]
  pub fn add_signer(&mut self, signer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Signature::VT_SIGNER, signer);
  }
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Signature::VT_SIGNATURE, signature);
  }
  #[inline]
...
impl<'a> Payload<'a> {
  ...
  pub fn type_(&self) -> ContentType {
    self._tab.get::<ContentType>(Payload::VT_TYPE_, Some(ContentType::MLS_COMMIT)).unwrap()
  }
  #[inline]
  ...
  pub fn timestamp(&self) -> i64 {
    self._tab.get::<i64>(Payload::VT_TIMESTAMP, Some(0)).unwrap()
  }
  #[inline]
  pub fn sender(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_SENDER, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn recipient(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_RECIPIENT, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn content(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_CONTENT, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for Payload<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"recipient", Self::VT_RECIPIENT, false)?
...
impl<'a: 'b, 'b> PayloadBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: ContentType) {
    self.fbb_.push_slot::<ContentType>(Payload::VT_TYPE_, type_, ContentType::MLS_COMMIT);
  }
  #[inline]
  pub fn add_sequence(&mut self, sequence: u64) {
    self.fbb_.push_slot::<u64>(Payload::VT_SEQUENCE, sequence, 0);
  }
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: i64) {
    self.fbb_.push_slot::<i64>(Payload::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
  pub fn add_sender(&mut self, sender: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Payload::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_recipient(&mut self, recipient: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Payload::VT_RECIPIENT, recipient);
  }
  #[inline]
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Payload::VT_CONTENT, content);
  }
  #[inline]
...
impl<'a> ProofOfWork<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args ProofOfWorkArgs<'args>) -> flatbuffers::WIPOffset<ProofOfWork<'bldr>> {
  ...
  pub fn hash(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(ProofOfWork::VT_HASH, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
    self._tab.get::<u64>(ProofOfWork::VT_NONCE, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> ProofOfWorkBuilder<'a, 'b> {
  ...
  pub fn add_hash(&mut self, hash: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ProofOfWork::VT_HASH, hash);
  }
  #[inline]
...
impl<'a> Message<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.pow { builder.add_pow(x); }
  ...
  #[inline]
  pub fn signatures(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature>>>>(Message::VT_SIGNATURES, None)
  }
  #[inline]
  pub fn pow(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_POW, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for Message<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Signature>>>>(&"signatures", Self::VT_SIGNATURES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"pow", Self::VT_POW, false)?
     .finish();
    Ok(())
  }
}
pub struct MessageArgs<'a> {
    ...
    pub signatures: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>>>,
...
impl<'a: 'b, 'b> MessageBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_signatures(&mut self, signatures: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Signature<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_SIGNATURES, signatures);
  }
  #[inline]
  pub fn add_pow(&mut self, pow: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_POW, pow);
  }
  #[inline]
...
impl<'a> MlsCommit<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args MlsCommitArgs<'args>) -> flatbuffers::WIPOffset<MlsCommit<'bldr>> {
      let mut builder = MlsCommitBuilder::new(_fbb);
      if let Some(x) = args.commit { builder.add_commit(x); }
      builder.finish()
    }
  ...
  pub fn commit(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsCommit::VT_COMMIT, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for MlsCommit<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"commit", Self::VT_COMMIT, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> MlsCommitBuilder<'a, 'b> {
  ...
  pub fn add_commit(&mut self, commit: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsCommit::VT_COMMIT, commit);
  }
  #[inline]
...
impl<'a> MlsWelcome<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args MlsWelcomeArgs<'args>) -> flatbuffers::WIPOffset<MlsWelcome<'bldr>> {
      let mut builder = MlsWelcomeBuilder::new(_fbb);
      if let Some(x) = args.subscription { builder.add_subscription(x); }
      if let Some(x) = args.send { builder.add_send(x); }
      if let Some(x) = args.welcome { builder.add_welcome(x); }
      builder.finish()
    }
  ...
  pub fn welcome(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsWelcome::VT_WELCOME, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn send(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsWelcome::VT_SEND, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn subscription(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsWelcome::VT_SUBSCRIPTION, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for MlsWelcome<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"welcome", Self::VT_WELCOME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"send", Self::VT_SEND, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"subscription", Self::VT_SUBSCRIPTION, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> MlsWelcomeBuilder<'a, 'b> {
  #[inline]
  pub fn add_welcome(&mut self, welcome: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsWelcome::VT_WELCOME, welcome);
  }
  #[inline]
  pub fn add_send(&mut self, send: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsWelcome::VT_SEND, send);
  }
  #[inline]
  pub fn add_subscription(&mut self, subscription: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsWelcome::VT_SUBSCRIPTION, subscription);
  }
  #[inline]
...
impl<'a> MlsMessage<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args MlsMessageArgs<'args>) -> flatbuffers::WIPOffset<MlsMessage<'bldr>> {
  ...
  pub fn message(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsMessage::VT_MESSAGE, None).map(|v| v.safe_slice())
  }
}
...
impl<'a: 'b, 'b> MlsMessageBuilder<'a, 'b> {
  ...
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsMessage::VT_MESSAGE, message);
  }
  #[inline]
...
impl<'a> MlsProposal<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args MlsProposalArgs<'args>) -> flatbuffers::WIPOffset<MlsProposal<'bldr>> {
      let mut builder = MlsProposalBuilder::new(_fbb);
      if let Some(x) = args.notification { builder.add_notification(x); }
      if let Some(x) = args.proposal { builder.add_proposal(x); }
      builder.finish()
    }
  ...
  pub fn proposal(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsProposal::VT_PROPOSAL, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn notification(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MlsProposal::VT_NOTIFICATION, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for MlsProposal<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"proposal", Self::VT_PROPOSAL, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"notification", Self::VT_NOTIFICATION, false)?
     .finish();
    Ok(())
  }
}
pub struct MlsProposalArgs<'a> {
    ...
    pub notification: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
}
...
impl<'a: 'b, 'b> MlsProposalBuilder<'a, 'b> {
  #[inline]
  pub fn add_proposal(&mut self, proposal: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsProposal::VT_PROPOSAL, proposal);
  }
  #[inline]
  pub fn add_notification(&mut self, notification: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MlsProposal::VT_NOTIFICATION, notification);
  }
  #[inline]
...
impl<'a> Acknowledgement<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args AcknowledgementArgs) -> flatbuffers::WIPOffset<Acknowledgement<'bldr>> {
...
impl<'a> Error<'a> {
  ...
  pub fn code(&self) -> StatusCode {
    self._tab.get::<StatusCode>(Error::VT_CODE, Some(StatusCode::BADAUTH)).unwrap()
  }
  #[inline]
  pub fn error(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Error::VT_ERROR, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for Error<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"error", Self::VT_ERROR, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> ErrorBuilder<'a, 'b> {
  ...
  pub fn add_code(&mut self, code: StatusCode) {
    self.fbb_.push_slot::<StatusCode>(Error::VT_CODE, code, StatusCode::BADAUTH);
  }
  #[inline]
...
impl<'a> SubscriptionDetails<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SubscriptionDetailsArgs<'args>) -> flatbuffers::WIPOffset<SubscriptionDetails<'bldr>> {
      let mut builder = SubscriptionDetailsBuilder::new(_fbb);
      builder.add_from(args.from);
      builder.add_issued(args.issued);
      if let Some(x) = args.inbox { builder.add_inbox(x); }
      builder.finish()
    }
  ...
  pub fn inbox(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SubscriptionDetails::VT_INBOX, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    self._tab.get::<i64>(SubscriptionDetails::VT_ISSUED, Some(0)).unwrap()
  }
  #[inline]
  pub fn from(&self) -> i64 {
    self._tab.get::<i64>(SubscriptionDetails::VT_FROM, Some(0)).unwrap()
  }
}
...
impl flatbuffers::Verifiable for SubscriptionDetails<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"inbox", Self::VT_INBOX, false)?
...
impl<'a: 'b, 'b> SubscriptionDetailsBuilder<'a, 'b> {
  ...
  pub fn add_inbox(&mut self, inbox: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SubscriptionDetails::VT_INBOX, inbox);
  }
  #[inline]
  pub fn add_issued(&mut self, issued: i64) {
    self.fbb_.push_slot::<i64>(SubscriptionDetails::VT_ISSUED, issued, 0);
  }
  #[inline]
  pub fn add_from(&mut self, from: i64) {
    self.fbb_.push_slot::<i64>(SubscriptionDetails::VT_FROM, from, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SubscriptionDetailsBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> Subscription<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SubscriptionArgs<'args>) -> flatbuffers::WIPOffset<Subscription<'bldr>> {
  ...
  pub fn details(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Subscription::VT_DETAILS, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn signatures(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature>>>>(Subscription::VT_SIGNATURES, None)
  }
}
...
impl flatbuffers::Verifiable for Subscription<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"details", Self::VT_DETAILS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Signature>>>>(&"signatures", Self::VT_SIGNATURES, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b> SubscriptionBuilder<'a, 'b> {
  #[inline]
  pub fn add_details(&mut self, details: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subscription::VT_DETAILS, details);
  }
  #[inline]
  pub fn add_signatures(&mut self, signatures: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Signature<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subscription::VT_SIGNATURES, signatures);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SubscriptionBuilder<'a, 'b> {
    let start = _fbb.start_table();
    SubscriptionBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Subscribe<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SubscribeArgs<'args>) -> flatbuffers::WIPOffset<Subscribe<'bldr>> {
      let mut builder = SubscribeBuilder::new(_fbb);
      if let Some(x) = args.subscriptions { builder.add_subscriptions(x); }
      builder.finish()
    }
  ...
  #[inline]
  pub fn subscriptions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Subscription<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Subscription>>>>(Subscribe::VT_SUBSCRIPTIONS, None)
  }
}
...
impl flatbuffers::Verifiable for Subscribe<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Subscription>>>>(&"subscriptions", Self::VT_SUBSCRIPTIONS, false)?
     .finish();
    Ok(())
  }
}
pub struct SubscribeArgs<'a> {
    pub subscriptions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Subscription<'a>>>>>,
}
...
impl<'a: 'b, 'b> SubscribeBuilder<'a, 'b> {
  #[inline]
  pub fn add_subscriptions(&mut self, subscriptions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Subscription<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subscribe::VT_SUBSCRIPTIONS, subscriptions);
  }
  #[inline]
...
impl<'a> OpenDetails<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args OpenDetailsArgs<'args>) -> flatbuffers::WIPOffset<OpenDetails<'bldr>> {
  ...
  #[inline]
  pub fn inbox(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(OpenDetails::VT_INBOX, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    self._tab.get::<i64>(OpenDetails::VT_ISSUED, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> OpenDetailsBuilder<'a, 'b> {
  #[inline]
  pub fn add_inbox(&mut self, inbox: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpenDetails::VT_INBOX, inbox);
  }
  #[inline]
  pub fn add_issued(&mut self, issued: i64) {
    self.fbb_.push_slot::<i64>(OpenDetails::VT_ISSUED, issued, 0);
  }
  #[inline]
...
impl<'a> Open<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args OpenArgs<'args>) -> flatbuffers::WIPOffset<Open<'bldr>> {
  ...
  #[inline]
  pub fn details(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Open::VT_DETAILS, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn pow(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Open::VT_POW, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
  ...
  pub fn signature(&self) -> Option<Signature<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Signature>>(Open::VT_SIGNATURE, None)
  }
}
...
impl flatbuffers::Verifiable for Open<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"pow", Self::VT_POW, false)?
     .visit_field::<u64>(&"nonce", Self::VT_NONCE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Signature>>(&"signature", Self::VT_SIGNATURE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> OpenBuilder<'a, 'b> {
  #[inline]
  pub fn add_details(&mut self, details: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Open::VT_DETAILS, details);
  }
  #[inline]
  pub fn add_pow(&mut self, pow: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Open::VT_POW, pow);
  }
  #[inline]
  pub fn add_nonce(&mut self, nonce: u64) {
  ...
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<Signature<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Signature>>(Open::VT_SIGNATURE, signature);
  }
  #[inline]
...
impl<'a> CloseDetails<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args CloseDetailsArgs<'args>) -> flatbuffers::WIPOffset<CloseDetails<'bldr>> {
  ...
  #[inline]
  pub fn inbox(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(CloseDetails::VT_INBOX, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    self._tab.get::<i64>(CloseDetails::VT_ISSUED, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> CloseDetailsBuilder<'a, 'b> {
  #[inline]
  pub fn add_inbox(&mut self, inbox: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CloseDetails::VT_INBOX, inbox);
  }
  #[inline]
  pub fn add_issued(&mut self, issued: i64) {
    self.fbb_.push_slot::<i64>(CloseDetails::VT_ISSUED, issued, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> CloseDetailsBuilder<'a, 'b> {
    let start = _fbb.start_table();
    CloseDetailsBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Close<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args CloseArgs<'args>) -> flatbuffers::WIPOffset<Close<'bldr>> {
  ...
  #[inline]
  pub fn details(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Close::VT_DETAILS, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn signature(&self) -> Option<Signature<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Signature>>(Close::VT_SIGNATURE, None)
  }
}
...
impl<'a: 'b, 'b> CloseBuilder<'a, 'b> {
  #[inline]
  pub fn add_details(&mut self, details: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Close::VT_DETAILS, details);
  }
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<Signature<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Signature>>(Close::VT_SIGNATURE, signature);
  }
  #[inline]
...
impl<'a> Event<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args EventArgs<'args>) -> flatbuffers::WIPOffset<Event<'bldr>> {
  ...
  pub fn version(&self) -> Version {
    self._tab.get::<Version>(Event::VT_VERSION, Some(Version::Unknown)).unwrap()
  }
  #[inline]
  ...
  pub fn type_(&self) -> EventType {
    self._tab.get::<EventType>(Event::VT_TYPE_, Some(EventType::ACKNOWLEDGEMENT)).unwrap()
  }
  #[inline]
  pub fn content(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Event::VT_CONTENT, None).map(|v| v.safe_slice())
  }
}
...
impl<'a: 'b, 'b> EventBuilder<'a, 'b> {
  ...
  pub fn add_version(&mut self, version: Version) {
    self.fbb_.push_slot::<Version>(Event::VT_VERSION, version, Version::Unknown);
  }
  #[inline]
  ...
  pub fn add_type_(&mut self, type_: EventType) {
    self.fbb_.push_slot::<EventType>(Event::VT_TYPE_, type_, EventType::ACKNOWLEDGEMENT);
  }
  #[inline]
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Event::VT_CONTENT, content);
  }
  #[inline]
