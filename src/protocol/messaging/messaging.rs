...
impl core::fmt::Debug for SignatureType {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> Signature<'a> {
  ...
  pub fn type_(&self) -> SignatureType {
    ...
    unsafe { self._tab.get::<SignatureType>(Signature::VT_TYPE_, Some(SignatureType::PAYLOAD)).unwrap()}
  }
  #[inline]
  pub fn signer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_SIGNER, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_SIGNATURE, None)}
  }
}
...
impl<'a> Payload<'a> {
  ...
  pub fn sequence(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Payload::VT_SEQUENCE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn timestamp(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Payload::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_SENDER, None)}
  }
  #[inline]
  pub fn recipient(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_RECIPIENT, None)}
  }
  #[inline]
  pub fn content(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Payload::VT_CONTENT, None)}
  }
}
...
impl<'a> ProofOfWork<'a> {
  ...
  pub fn hash(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(ProofOfWork::VT_HASH, None)}
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ProofOfWork::VT_NONCE, Some(0)).unwrap()}
  }
}
...
impl core::fmt::Debug for ProofOfWork<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> Message<'a> {
  ...
  pub fn payload(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_PAYLOAD, None)}
  }
  #[inline]
  pub fn signatures(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature>>>>(Message::VT_SIGNATURES, None)}
  }
  #[inline]
  pub fn pow(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_POW, None)}
  }
}
...
impl<'a> Error<'a> {
  ...
  pub fn code(&self) -> StatusCode {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StatusCode>(Error::VT_CODE, Some(StatusCode::BADAUTH)).unwrap()}
  }
  #[inline]
  pub fn error(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Error::VT_ERROR, None)}
  }
}
...
impl<'a> SubscriptionDetails<'a> {
  ...
  #[inline]
  pub fn inbox(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SubscriptionDetails::VT_INBOX, None)}
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(SubscriptionDetails::VT_ISSUED, Some(0)).unwrap()}
  }
  #[inline]
  pub fn from(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(SubscriptionDetails::VT_FROM, Some(0)).unwrap()}
  }
}
...
impl core::fmt::Debug for SubscriptionDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> Subscription<'a> {
  ...
  #[inline]
  pub fn details(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Subscription::VT_DETAILS, None)}
  }
  #[inline]
  pub fn signatures(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature>>>>(Subscription::VT_SIGNATURES, None)}
  }
}
...
impl<'a> Subscribe<'a> {
  ...
  pub fn subscriptions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Subscription<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Subscription>>>>(Subscribe::VT_SUBSCRIPTIONS, None)}
  }
}
...
impl<'a> OpenDetails<'a> {
  ...
  pub fn inbox(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(OpenDetails::VT_INBOX, None)}
  }
  #[inline]
  pub fn nonce(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(OpenDetails::VT_NONCE, None)}
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(OpenDetails::VT_ISSUED, Some(0)).unwrap()}
  }
}
...
impl core::fmt::Debug for OpenDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> Open<'a> {
  ...
  pub fn details(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Open::VT_DETAILS, None)}
  }
  #[inline]
  pub fn pow(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Open::VT_POW, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<Signature<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Signature>>(Open::VT_SIGNATURE, None)}
  }
}
...
impl core::fmt::Debug for Open<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> CloseDetails<'a> {
  ...
  pub fn inbox(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(CloseDetails::VT_INBOX, None)}
  }
  #[inline]
  pub fn issued(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(CloseDetails::VT_ISSUED, Some(0)).unwrap()}
  }
}
...
impl core::fmt::Debug for CloseDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> Close<'a> {
  ...
  pub fn details(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Close::VT_DETAILS, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<Signature<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Signature>>(Close::VT_SIGNATURE, None)}
  }
}
...
impl core::fmt::Debug for Close<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<'a> Event<'a> {
  ...
  pub fn version(&self) -> Version {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Version>(Event::VT_VERSION, Some(Version::Unknown)).unwrap()}
  }
  #[inline]
  pub fn id(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Event::VT_ID, None)}
  }
  #[inline]
  pub fn type_(&self) -> ContentType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ContentType>(Event::VT_TYPE_, Some(ContentType::ACKNOWLEDGEMENT)).unwrap()}
  }
  #[inline]
  pub fn content(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Event::VT_CONTENT, None)}
  }
}
