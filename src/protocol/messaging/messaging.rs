...
impl<'a> OpenDetails<'a> {
  ...
  pub fn nonce(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(OpenDetails::VT_NONCE, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn issued(&self) -> i64 {
...
impl<'a: 'b, 'b> OpenDetailsBuilder<'a, 'b> {
  ...
  pub fn add_nonce(&mut self, nonce: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpenDetails::VT_NONCE, nonce);
  }
  #[inline]
  pub fn add_issued(&mut self, issued: i64) {
...
impl<'a> Event<'a> {
  ...
  pub fn type_(&self) -> ContentType {
    self._tab.get::<ContentType>(Event::VT_TYPE_, Some(ContentType::ACKNOWLEDGEMENT)).unwrap()
  }
  #[inline]
  pub fn content(&self) -> Option<&'a [u8]> {
...
impl<'a: 'b, 'b> EventBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: ContentType) {
    self.fbb_.push_slot::<ContentType>(Event::VT_TYPE_, type_, ContentType::ACKNOWLEDGEMENT);
  }
  #[inline]
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
