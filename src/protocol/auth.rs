...
impl<'a> Auth<'a> {
    ...
    pub fn id(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Auth::VT_ID, None)
    }
    #[inline]
    pub fn msgtype(&self) -> MsgType {
        self._tab
            .get::<MsgType>(Auth::VT_MSGTYPE, Some(MsgType::MSG))
            .unwrap()
    }
    #[inline]
    pub fn token(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Auth::VT_TOKEN, None)
    }
    #[inline]
    pub fn device(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Auth::VT_DEVICE, None)
    }
    #[inline]
...
impl<'a: 'b, 'b> AuthBuilder<'a, 'b> {
    ...
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Auth::VT_ID, id);
    }
    #[inline]
    pub fn add_msgtype(&mut self, msgtype: MsgType) {
        self.fbb_
            .push_slot::<MsgType>(Auth::VT_MSGTYPE, msgtype, MsgType::MSG);
    }
    #[inline]
    pub fn add_token(&mut self, token: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Auth::VT_TOKEN, token);
    }
    #[inline]
    pub fn add_device(&mut self, device: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Auth::VT_DEVICE, device);
    }
    #[inline]
...
#[inline]
pub fn finish_size_prefixed_auth_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<Auth<'a>>,
) {
