...
impl<'a> Message<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.notification_payload { builder.add_notification_payload(x); }
    if let Some(x) = args.collapse_key { builder.add_collapse_key(x); }
  ...
  pub fn id(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Message::VT_ID, None)
  }
  #[inline]
  pub fn msgtype(&self) -> MsgType {
    self._tab.get::<MsgType>(Message::VT_MSGTYPE, Some(MsgType::MSG)).unwrap()
  }
  #[inline]
  pub fn subtype(&self) -> MsgSubType {
    self._tab.get::<MsgSubType>(Message::VT_SUBTYPE, Some(MsgSubType::Unknown)).unwrap()
  }
  #[inline]
  pub fn sender(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Message::VT_SENDER, None)
  }
  #[inline]
  pub fn recipient(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Message::VT_RECIPIENT, None)
  }
  #[inline]
  pub fn metadata(&self) -> &'a Metadata {
    self._tab.get::<Metadata>(Message::VT_METADATA, None).unwrap()
  }
  #[inline]
  pub fn ciphertext(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_CIPHERTEXT, None).map(|v| v.safe_slice())
  }
  #[inline]
  ...
  pub fn message_type(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_MESSAGE_TYPE, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn collapse_key(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_COLLAPSE_KEY, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn notification_payload(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Message::VT_NOTIFICATION_PAYLOAD, None).map(|v| v.safe_slice())
  }
}
...
impl flatbuffers::Verifiable for Message<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("message_type", Self::VT_MESSAGE_TYPE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("collapse_key", Self::VT_COLLAPSE_KEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("notification_payload", Self::VT_NOTIFICATION_PAYLOAD, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> MessageBuilder<'a, 'b> {
  ...
  pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_ID, id);
  }
  #[inline]
  pub fn add_msgtype(&mut self, msgtype: MsgType) {
    self.fbb_.push_slot::<MsgType>(Message::VT_MSGTYPE, msgtype, MsgType::MSG);
  }
  #[inline]
  pub fn add_subtype(&mut self, subtype: MsgSubType) {
    self.fbb_.push_slot::<MsgSubType>(Message::VT_SUBTYPE, subtype, MsgSubType::Unknown);
  }
  #[inline]
  ...
  pub fn add_metadata(&mut self, metadata: &Metadata) {
    self.fbb_.push_slot_always::<&Metadata>(Message::VT_METADATA, metadata);
  }
  #[inline]
  pub fn add_ciphertext(&mut self, ciphertext: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_CIPHERTEXT, ciphertext);
  }
  #[inline]
  pub fn add_priority(&mut self, priority: u32) {
    self.fbb_.push_slot::<u32>(Message::VT_PRIORITY, priority, 0);
  }
  #[inline]
  pub fn add_message_type(&mut self, message_type: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_MESSAGE_TYPE, message_type);
  }
  #[inline]
  pub fn add_collapse_key(&mut self, collapse_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_COLLAPSE_KEY, collapse_key);
  }
  #[inline]
  pub fn add_notification_payload(&mut self, notification_payload: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_NOTIFICATION_PAYLOAD, notification_payload);
  }
  #[inline]
