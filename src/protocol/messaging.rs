...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_SIGNATURE_TYPE: i8 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SIGNATURE_TYPE: [SignatureType; 4] = [
  SignatureType::AUTH,
  SignatureType::PAYLOAD,
  SignatureType::DELEGATION,
  SignatureType::SUBSCRIPTION,
];
...
impl SignatureType {
  ...
  pub const DELEGATION: Self = Self(2);
...
impl<'a> Signature<'a> {
  ...
  pub fn type_(&self) -> SignatureType {
    self._tab.get::<SignatureType>(Signature::VT_TYPE_, Some(SignatureType::AUTH)).unwrap()
  }
  #[inline]
...
impl<'a: 'b, 'b> SignatureBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: SignatureType) {
    self.fbb_.push_slot::<SignatureType>(Signature::VT_TYPE_, type_, SignatureType::AUTH);
  }
  #[inline]
