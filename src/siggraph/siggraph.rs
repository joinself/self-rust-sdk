...
pub const ENUM_VALUES_KEY_ALGORITHM: [KeyAlgorithm; 1] = [
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_KEY_ROLE: [KeyRole; 2] = [
  KeyRole::Signing,
  KeyRole::Recovery,
];
...
impl<'a> CreateKey<'a> {
  ...
  pub fn key(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(CreateKey::VT_KEY, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn alg(&self) -> KeyAlgorithm {
    self._tab.get::<KeyAlgorithm>(CreateKey::VT_ALG, Some(KeyAlgorithm::Ed25519)).unwrap()
  }
  #[inline]
  pub fn role(&self) -> KeyRole {
    self._tab.get::<KeyRole>(CreateKey::VT_ROLE, Some(KeyRole::Signing)).unwrap()
  }
  #[inline]
  pub fn effective_from(&self) -> i64 {
    self._tab.get::<i64>(CreateKey::VT_EFFECTIVE_FROM, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> CreateKeyBuilder<'a, 'b> {
  ...
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateKey::VT_KEY, key);
  }
  #[inline]
  pub fn add_alg(&mut self, alg: KeyAlgorithm) {
    self.fbb_.push_slot::<KeyAlgorithm>(CreateKey::VT_ALG, alg, KeyAlgorithm::Ed25519);
  }
  #[inline]
  pub fn add_role(&mut self, role: KeyRole) {
    self.fbb_.push_slot::<KeyRole>(CreateKey::VT_ROLE, role, KeyRole::Signing);
  }
  #[inline]
  pub fn add_effective_from(&mut self, effective_from: i64) {
    self.fbb_.push_slot::<i64>(CreateKey::VT_EFFECTIVE_FROM, effective_from, 0);
  }
  #[inline]
...
impl<'a> RevokeKey<'a> {
  ...
  #[inline]
  pub fn key(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(RevokeKey::VT_KEY, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn effective_from(&self) -> i64 {
    self._tab.get::<i64>(RevokeKey::VT_EFFECTIVE_FROM, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> RevokeKeyBuilder<'a, 'b> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RevokeKey::VT_KEY, key);
  }
  #[inline]
  pub fn add_effective_from(&mut self, effective_from: i64) {
    self.fbb_.push_slot::<i64>(RevokeKey::VT_EFFECTIVE_FROM, effective_from, 0);
  }
  #[inline]
...
impl<'a> Recover<'a> {
  ...
  #[inline]
  pub fn effective_from(&self) -> i64 {
    self._tab.get::<i64>(Recover::VT_EFFECTIVE_FROM, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> RecoverBuilder<'a, 'b> {
  #[inline]
  pub fn add_effective_from(&mut self, effective_from: i64) {
    self.fbb_.push_slot::<i64>(Recover::VT_EFFECTIVE_FROM, effective_from, 0);
  }
  #[inline]
...
impl<'a> Action<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.actionable { builder.add_actionable(x); }
  ...
  pub fn actionable_type(&self) -> Actionable {
    self._tab.get::<Actionable>(Action::VT_ACTIONABLE_TYPE, Some(Actionable::NONE)).unwrap()
  }
  #[inline]
  pub fn actionable(&self) -> Option<flatbuffers::Table<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Action::VT_ACTIONABLE, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for Action<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<Actionable, _>("actionable_type", Self::VT_ACTIONABLE_TYPE, "actionable", Self::VT_ACTIONABLE, false, |key, v, pos| {
        match key {
          Actionable::CreateKey => v.verify_union_variant::<flatbuffers::ForwardsUOffset<CreateKey>>("Actionable::CreateKey", pos),
          Actionable::RevokeKey => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RevokeKey>>("Actionable::RevokeKey", pos),
          Actionable::Recover => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Recover>>("Actionable::Recover", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> ActionBuilder<'a, 'b> {
  ...
  pub fn add_actionable_type(&mut self, actionable_type: Actionable) {
    self.fbb_.push_slot::<Actionable>(Action::VT_ACTIONABLE_TYPE, actionable_type, Actionable::NONE);
  }
  #[inline]
  pub fn add_actionable(&mut self, actionable: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Action::VT_ACTIONABLE, actionable);
  }
  #[inline]
      ...
      match self.actionable_type() {
        Actionable::CreateKey => {
          if let Some(x) = self.actionable_as_create_key() {
            ...
            ds.field("actionable", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        Actionable::RevokeKey => {
...
impl<'a> Operation<'a> {
  ...
  pub fn sequence(&self) -> u32 {
    self._tab.get::<u32>(Operation::VT_SEQUENCE, Some(0)).unwrap()
  }
  #[inline]
  pub fn previous(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Operation::VT_PREVIOUS, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn timestamp(&self) -> i64 {
    self._tab.get::<i64>(Operation::VT_TIMESTAMP, Some(0)).unwrap()
  }
  #[inline]
  pub fn actions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Action<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Action>>>>(Operation::VT_ACTIONS, None)
  }
}
...
impl flatbuffers::Verifiable for Operation<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("previous", Self::VT_PREVIOUS, false)?
...
impl<'a: 'b, 'b> OperationBuilder<'a, 'b> {
  ...
  pub fn add_sequence(&mut self, sequence: u32) {
    self.fbb_.push_slot::<u32>(Operation::VT_SEQUENCE, sequence, 0);
  }
  #[inline]
  pub fn add_previous(&mut self, previous: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Operation::VT_PREVIOUS, previous);
  }
  #[inline]
  ...
  pub fn add_actions(&mut self, actions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Action<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Operation::VT_ACTIONS, actions);
  }
  #[inline]
...
impl<'a> SignatureHeader<'a> {
  ...
  pub fn signer(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SignatureHeader::VT_SIGNER, None).map(|v| v.safe_slice())
  }
}
...
impl<'a: 'b, 'b> SignatureHeaderBuilder<'a, 'b> {
  ...
  pub fn add_signer(&mut self, signer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SignatureHeader::VT_SIGNER, signer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SignatureHeaderBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> Signature<'a> {
  ...
  pub fn header(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Signature::VT_HEADER, None).map(|v| v.safe_slice())
  }
  #[inline]
...
impl<'a: 'b, 'b> SignatureBuilder<'a, 'b> {
  ...
  pub fn add_header(&mut self, header: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Signature::VT_HEADER, header);
  }
  #[inline]
...
impl<'a> SignedOperation<'a> {
  ...
  pub fn operation(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SignedOperation::VT_OPERATION, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn signatures(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Signature>>>>(SignedOperation::VT_SIGNATURES, None)
  }
}
...
impl flatbuffers::Verifiable for SignedOperation<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("operation", Self::VT_OPERATION, false)?
...
impl<'a: 'b, 'b> SignedOperationBuilder<'a, 'b> {
  #[inline]
  pub fn add_operation(&mut self, operation: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SignedOperation::VT_OPERATION, operation);
  }
  #[inline]
  pub fn add_signatures(&mut self, signatures: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Signature<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SignedOperation::VT_SIGNATURES, signatures);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SignedOperationBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
pub fn root_as_signed_operation(buf: &[u8]) -> Result<SignedOperation, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_signed_operation(buf: &[u8]) -> Result<SignedOperation, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_signed_operation_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<SignedOperation<'a>>) {
